    ...
    def __init__(
        ...
        for path in all_files:
            ...
            for idx in range(0, num_sequences * self.skip + 1, skip):
                ...
                curr_seq_rel = np.zeros((len(peds_in_curr_seq), 3, self.seq_len))		# modified 2 to 3 for (x, y, z)
                curr_seq = np.zeros((len(peds_in_curr_seq), 3, self.seq_len))			# modified 2 to 3 for (x, y, z)
                ...
                for _, ped_id in enumerate(peds_in_curr_seq):
                    ...
                    rel_curr_ped_seq[:, 1:] = curr_ped_seq[:, 1:] - curr_ped_seq[:, :-1]	# x2 - x1
